              ...
              children: <Widget>[
                ...
                new Row(
                  children: <Widget>[
                    new Container(
                      child: new Chip(
                        label: new FlatButton(onPressed: (){}, child: new Text("小米9",style: new TextStyle(color: GlobalConfig.fontColor))),
                    ...
                    new Container(
                      child: new Chip(
                        label: new FlatButton(onPressed: (){}, child: new Text("同居",style: new TextStyle(color: GlobalConfig.fontColor))),
                        backgroundColor: GlobalConfig.dark == true ? Colors.white10 : Colors.black12,
                      ),
                      margin: const EdgeInsets.only(left: 16.0, bottom: 16.0),
                      alignment: Alignment.topLeft,
